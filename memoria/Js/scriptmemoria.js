...
/*informações da imagem dos cartões */
let cardsList = [
...
/*criando duplicata dos cartões */
let cardGrid = cardsList.concat(cardsList);
/*criando grade aleatória embaralhando a matriz de cartas */
//le percorre o array da direita para a esquerda e, para cada elemento, gera um índice aleatório entre 0 e o índice atual, trocando os elementos de posição. A função retorna o array embaralhado.
...
// função para quando o usuario vira duas cartas diferentes
